...
const reducer = (state = initialState, action) => {
  switch(action.type)
  {
    ...
    case 'SELECT_FOOD':
      return {selectFood: action.payload}
    case 'SELECTED_MEAL':
